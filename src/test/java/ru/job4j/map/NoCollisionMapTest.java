...
class NonCollisionMapTest {
    ...
    private final NonCollisionMap<Integer, String> map = new NonCollisionMap<>();
    ...
    void whenPutMinesKey() {
        ...
        assertThat(map).hasSize(8).contains(-1, 1, 2, -6, 3, -7, 4, -8);
    }

    @Test
    void whenPutMinesFalseKey() {
        assertThat(map.put(-2, "-2")).isFalse();
    }

    @Test
    void whenPutRemovePutCoupleMinesKey() {
        assertThat(map.put(-2, "-2")).isFalse();
        assertThat(map.remove(1)).isTrue();
        assertThat(map.put(-2, "-2")).isTrue();
        assertThat(map).hasSize(4).contains(-2, 2, 3, 4);
    }

    @Test
    void whenRemoveAllCantGetAny() {
        ...
        assertThat(map.get(3)).isEqualTo(null);
        assertThat(map.get(1)).isEqualTo(null);
        assertThat(map.get(4)).isEqualTo(null);
    }

    @Test
    void whenPutRemoveIteratorRemoveGetThenCCMExeption() {
        SimpleMap<Integer, String> map1 = new NonCollisionMap<>();
        assertThat(map1.put(2, "2")).isTrue();
        assertThat(map1.put(5, "5")).isTrue();
        assertThat(map1.remove(2)).isTrue();
        Iterator<Integer> it = map1.iterator();
        assertThat(it.next()).isEqualTo(5);
        assertThat(map1.get(5)).isEqualTo("5");
        assertThat(map1.put(7, "7")).isTrue();
